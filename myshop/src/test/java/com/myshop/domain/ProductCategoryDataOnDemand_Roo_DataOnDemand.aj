...
privileged aspect ProductCategoryDataOnDemand_Roo_DataOnDemand {
    ...
    public void ProductCategoryDataOnDemand.setLastModifiedDate(ProductCategory obj, int index) {
        Date lastModifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setLastModifiedDate(lastModifiedDate);
    }
    
    public void ProductCategoryDataOnDemand.setName(ProductCategory obj, int index) {
