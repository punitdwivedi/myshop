...
import com.myshop.domain.RolesDataOnDemand;
import com.myshop.domain.UserRole;
import com.myshop.domain.UserRoleDataOnDemand;
...
privileged aspect UserRoleDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    RolesDataOnDemand UserRoleDataOnDemand.rolesDataOnDemand;
    
    @Autowired
    UsersDataOnDemand UserRoleDataOnDemand.usersDataOnDemand;
